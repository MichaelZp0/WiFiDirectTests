...
class KeepAliveWiFiDirectService : Service() {
    ...
    private inner class ServiceHandler(looper: Looper) : Handler(looper) {
        override fun handleMessage(msg: Message) {
            ...
            Log.i(null, "Enter service handler handleMessage")
            // Do work
            ...
            Log.i(null, "Got sockets in foreground task")

            MyBroadcastReceiver.keepAliveSocket!!.start()
            MyBroadcastReceiver.dataTransferSocket!!.start()

            Log.i(null, "Started sockets in foreground task")
            ...
            Log.i(null, "Sockets died, so closing foreground task")
    ...
    override fun onCreate() {
        ...
        Log.i(null, "Service is being created")
